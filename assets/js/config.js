...
Obrigado!`,
  ...
  heroMosaic: [
    { imagem: '/assets/images/instagram/09-DBlvtvKuqyj.jpg', shortcode: 'DBlvtvKuqyj', alt: 'Fachada Performance Hyosung — Vila Jardim', shape: 'hero' },
    { imagem: '/assets/images/instagram/07-DCM2-2Ixvpf.jpg', shortcode: 'DCM2-2Ixvpf', alt: 'Motos na Performance Hyosung', shape: 'wide' },
    { imagem: '/assets/images/instagram/05-DFBKcgCR5BY.jpg', shortcode: 'DFBKcgCR5BY', alt: 'Comet entregue na oficina', shape: 'diamond' },
    { imagem: '/assets/images/instagram/11-C_5-k7SxRJd.jpg', shortcode: 'C_5-k7SxRJd', alt: 'Equipe Performance Hyosung', shape: 'square' },
    { imagem: '/assets/images/instagram/12-DBUbtRBxSaT.jpg', shortcode: 'DBUbtRBxSaT', alt: 'Hyosung Performance — Kasinski e Hyosung', shape: 'slant' },
    { imagem: '/assets/images/instagram/04-DFBKsxNxV4R.jpg', shortcode: 'DFBKsxNxV4R', alt: 'Revisão e mecânica de motos coreanas', shape: 'strip' },
    { imagem: '/assets/images/instagram/01-DKLGTEdOzxN.jpg', shortcode: 'DKLGTEdOzxN', alt: 'Entrega de moto ao cliente', shape: 'block' },
    { imagem: '/assets/images/instagram/02-DHcNxSvOk57.jpg', shortcode: 'DHcNxSvOk57', alt: 'Oficina Performance Hyosung', shape: 'tall' },
    { imagem: '/assets/images/instagram/06-DEvpJ8Oub71.jpg', shortcode: 'DEvpJ8Oub71', alt: 'Revisão elétrica na oficina', shape: 'hexagon' },
    { imagem: '/assets/images/instagram/08-DBz3fwrOQUn.jpg', shortcode: 'DBz3fwrOQUn', alt: 'Oficina na Vila Jardim', shape: 'square' },
    { imagem: '/assets/images/instagram/10-DBi1w_nONXw.jpg', shortcode: 'DBi1w_nONXw', alt: 'Área de reparação da motocicleta', shape: 'square' },
    { imagem: '/assets/images/instagram/03-DFlvMhYO1_v.jpg', shortcode: 'DFlvMhYO1_v', alt: 'Trabalhos na Performance Hyosung', shape: 'banner' },
  ],
